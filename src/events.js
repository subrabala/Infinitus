...
loader.load("./models/02/scene.gltf", function (glb) {
...
//Light
const light = new THREE.AmbientLight("#00FFFF", 0.2);
light.position.set(10, 10, 10);
light.intensity = 2;
scene.add(light);

const directionalLight = new THREE.DirectionalLight("#00FFFF", 0.3);
